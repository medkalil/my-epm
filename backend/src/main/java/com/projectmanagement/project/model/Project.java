...
public class Project {
    ...
    public List<com.projectmanagement.task.model.Task> getTasks() { return tasks; }
    public void setTasks(List<com.projectmanagement.task.model.Task> tasks) { this.tasks = tasks; }
}
